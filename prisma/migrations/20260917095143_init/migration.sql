...
CREATE TABLE "SiteSettings" (
    ...
    "companyName" TEXT NOT NULL DEFAULT 'Aarav Industries',
    "tagline" TEXT NOT NULL DEFAULT 'Quality Manufacturing. Reliable Solutions.',
    "phone" TEXT NOT NULL DEFAULT '+91 98765 43210',
    "email" TEXT NOT NULL DEFAULT 'sales@aaravindustries.example',
    "address" TEXT NOT NULL DEFAULT 'Plot No. 42, MIDC Industrial Area, Hingna Road, Nagpur, Maharashtra - 440016',
